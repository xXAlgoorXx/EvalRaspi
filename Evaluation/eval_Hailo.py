...
from Evaluation.cpuEval_utils import get_max_class_with_threshold,get_trueClass,find_majority_element,printAndSaveHeatmap
from hailoEval_utils import get_pred_hailo,get_throughput_hailo, HailoCLIPImage, HailoCLIPText
...
hef_path = "Evaluation/resources/Modified_RN50x4.hef" # get from for loop
postprocess_path = "gemm_layer_RNx4.json"
textEmbeddings_path = "textEmbeddings_RN50x4.json"
